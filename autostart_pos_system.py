#!/usr/bin/env python3
"""
🚀 SISTEMA POS AVANZADO - INICIO AUTOMÁTICO
===============================================
...
class POSAutoStart:
    ...
    def open_browser(self, url, delay=5):
        """Abrir navegador con la interfaz"""
        logger.info(f"Abriendo navegador en {url} (delay: {delay}s)")
        
        def open_delayed():
            time.sleep(delay)
            try:
                webbrowser.open(url, new=2)  # new=2 abre en nueva ventana
    ...
    def run(self):
        ...
        logger.info("=" * 60)
        logger.info("SISTEMA POS AVANZADO - INICIO AUTOMÁTICO")
        logger.info("=" * 60)
        ...
        try:
            ...
            if pos_started:
                logger.info("Abriendo interfaz POS avanzada...")
                self.open_browser(self.pos_frontend_url, delay=3)
            else:
                logger.info("Abriendo interfaz Streamlit...")
                self.open_browser(self.frontend_url, delay=3)
